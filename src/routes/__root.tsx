...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Pass our trading challenge and trade up to $200K of our capital. Keep up to 90% of profits." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FundedPlus — Get Funded. Trade Bigger." },
      { name: "twitter:description", content: "Pass our trading challenge and trade up to $200K of our capital. Keep up to 90% of profits." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/5d5c241a-9225-49d0-811d-8f4f1d41f872" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/5d5c241a-9225-49d0-811d-8f4f1d41f872" },
    ],
