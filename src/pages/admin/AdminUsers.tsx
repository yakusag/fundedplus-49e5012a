  ...
  return (
    <div className="p-6 md:p-10 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1.5">All registered traders on the platform.</p>
      </div>
      ...
      <div className="glass rounded-2xl overflow-hidden">
        ...
        <div className="p-12 text-center">
          ...
          <p className="text-muted-foreground text-sm">No users found. Connect a database to populate this list.</p>
        </div>
      </div>
    </div>
  );
